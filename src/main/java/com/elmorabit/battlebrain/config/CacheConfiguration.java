package com.elmorabit.battlebrain.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, com.elmorabit.battlebrain.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, com.elmorabit.battlebrain.repository.UserRepository.USERS_BY_EMAIL_CACHE);

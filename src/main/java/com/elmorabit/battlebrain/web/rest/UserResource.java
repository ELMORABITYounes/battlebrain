...
import com.elmorabit.battlebrain.web.rest.errors.EmailAlreadyUsedException;
import com.elmorabit.battlebrain.web.rest.errors.LoginAlreadyUsedException;
...
public class UserResource {
    ...
    public ResponseEntity<UserDTO> getUser(@PathVariable String login) {
        ...
        return ResponseUtil.wrapOrNotFound(
            userService.getUserWithAuthoritiesWithTeamByLogin(login)
                .map(UserDTO::new));
    }

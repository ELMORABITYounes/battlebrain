...
export class ReservationService {
  ...
  protected convertDateFromClient(reservation: IReservation): IReservation {
    const copy: IReservation = Object.assign({}, reservation, {
      startDate: reservation.startDate && reservation.startDate.isValid() ? reservation.startDate.toJSON() : undefined,
      endDate: reservation.endDate && reservation.endDate.isValid() ? reservation.endDate.toJSON() : undefined,
    });
    return copy;
  }
